...
public class BlockRoadStone extends BlockRoadBase implements ITileEntityProvider {
	public BlockRoadStone() {
		super(Material.rock, "pickaxe", 0, 2F, 0.4F, 1.5F, 10.0F, Block.soundTypeStone);
		this.setBlockName(Ref.Name.Block.ROADStone);
		this.setBlockTextureName(Ref.Name.Block.ROADStone);
