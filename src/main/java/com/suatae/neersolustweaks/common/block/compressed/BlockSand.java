...
public class BlockSand extends BlockCompBaseFalling {
	public static int		maxMeta	= 8;
	private final String	name	= Ref.Name.Block.sand;
	private final String	namei	= Ref.Name.Block.isand;
	@SideOnly(Side.CLIENT)
	private IIcon[]			icons;

	public BlockSand() {
		super(Material.sand, "shovel", 0, 0.5F, 0F, Block.soundTypeSand);
